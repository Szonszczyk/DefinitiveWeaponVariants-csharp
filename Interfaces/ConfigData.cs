namespace DefinitiveWeaponVariants.Interfaces
{
    public class ConfigData
    {
        ...
        public float MarkedRoomsProbability { get; set; } = 0.3f; // 12.1.1
        public float StaticLootProbability { get; set; } = 0.3f; // 12.1.2
        public float LooseLootProbability { get; set; } = 0; // 12.1.3
